...
โดยภายในจะมีการใช้ while loop สำหรับการเช็คค่าก่อนว่ามี element.lenght > 0 หรือไม่(มีตัวที่ให้ลบหรือไม่) 
หากใช่จะทำการลบ child โดยไล่ลบจากตำแหน่งที่ 0 จนหมด */
